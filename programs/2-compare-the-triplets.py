...
The task is to find their comparison points by comparing a[0] with b[0], a
[1] with b[1], and a[2] with b[2].
...
Return
 - int[2]: Alice's score is in the first position, and Bob's score is in
  the second.
